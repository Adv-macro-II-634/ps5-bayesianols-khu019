...
v_n_std = .01*[std_all(1),std_all(2),std_all(3),std_all(4),...
...
% results:
figure(1)
histfit(para_dist(:,1),20)
title('distn of beta0')
figure(2)
histfit(para_dist(:,2),20)
title('distn of beta1')
figure(3)
histfit(para_dist(:,3),20)
title('distn of beta2')
figure(4)
histfit(para_dist(:,4),20)
title('distn of beta3')
figure(5)
histfit(para_dist(:,5),20)
title('distn of beta4')
figure(6)
histfit(para_dist(:,6),20)
title('distn of beta5')
figure(7)
histfit(para_dist(:,7),20)
